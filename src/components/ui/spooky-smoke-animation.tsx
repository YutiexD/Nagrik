...
void main(){gl_Position=position;}`;
  ...
  private color: [number, number, number] = [0.1, 0.725, 0.505]; // Default matching emerald theme
...
// Converts a hex color string like "#FF5733" to [r, g, b]
...
export const SmokeBackground: React.FC<SmokeBackgroundProps> = ({ 
  smokeColor = "#10B981" // Default to emerald green matching the theme
}) => {
    ...
    return (
      <div className="fixed inset-0 w-full h-full overflow-hidden pointer-events-none z-[-10] bg-[#06070a]">
        <canvas ref={canvasRef} className="w-full h-full block opacity-[0.12]" />
      </div>
    );
};
